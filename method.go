...
func (client *Client) SetTdlibParameters(parameters *TdlibParameters, timeout time.Duration) (*Ok, error) {
	var err error
	var result UpdateMsg
	if myos.IsMac() {
		result, err = client.SendAndCatch(UpdateData{
		...
		var paramerMap map[string]any
		jb, err := json.Marshal(parameters)
		if err != nil {
			return nil, err
		}
		if err = json.Unmarshal(jb, &paramerMap); err != nil {
			return nil, err
		}
		paramerMap["@type"] = "setTdlibParameters"
		param, err := json.Marshal(paramerMap)
		if err != nil {
			return nil, err
		}
		result, err = client.SendAndCatch(string(param), timeout)
	}
...
func (client *Client) CheckDatabaseEncryptionKey(encryptionKey []byte, timeout time.Duration) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *Client) SetAuthenticationPhoneNumber(phoneNumber string, settings *PhoneNumberAuthenticationSettings, timeout time.Duration) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *Client) GetSecretChat(secretChatID int64) (*SecretChat, error) {
	result, err := client.SendAndCatch(UpdateData{
		"@type":          "getSecretChat",
...
func (client *Client) RemoveNotification(notificationGroupID int64, notificationID int32) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
...
func (client *Client) RemoveNotificationGroup(notificationGroupID int64, maxNotificationID int32) (*Ok, error) {
	result, err := client.SendAndCatch(UpdateData{
